...
public:
	SLATE_BEGIN_ARGS(SBAFilteredList)
		...
		SLATE_ARGUMENT(bool, CloseWhenSelecting)
	SLATE_END_ARGS()
...
public:
	...
	void Construct(const FArguments& InArgs)
	{
		...
		bCloseWhenSelecting = InArgs._CloseWhenSelecting;
